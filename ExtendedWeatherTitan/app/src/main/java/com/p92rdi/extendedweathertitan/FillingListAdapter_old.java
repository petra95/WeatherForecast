 ...
 */
public class FillingListAdapter_old extends ArrayAdapter<Mok2> {

    private List<Mok2> fillings;
    private LayoutInflater inflater;

    public FillingListAdapter_old(Context context, List<Mok2> fillings) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.minImageView = (ImageView) convertView.findViewById(R.id.nightImageView);
            holder.minDegTextView5 = (TextView) convertView.findViewById(R.id.nightDegTextView5);
            holder.maxDegTextView5 = (TextView) convertView.findViewById(R.id.dayDegTextView5);
            holder.maxImageView = (ImageView) convertView.findViewById(R.id.dayImageView);
            holder.tvminDescription = (TextView) convertView.findViewById(R.id.tvNightDescription);
            holder.tvmaxDescription = (TextView) convertView.findViewById(R.id.tvDayDescription);
